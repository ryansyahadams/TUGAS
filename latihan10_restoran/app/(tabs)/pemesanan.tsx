...
export default function PemesananScreen() {
  ...
  async function onRefresh() {
    ...
    try {
      ...
      console.log("Gagal refresh data:", error);
      ...
      <ScrollView 
        ...
        refreshControl={
          <RefreshControl
            ...
            onRefresh={onRefresh}
            colors={["#f97316"]} // Warna loading indicator (Android)
            tintColor="#f97316" // Warna loading indicator (iOS)
            title="Menarik data..." // Teks saat loading (iOS)
            titleColor="#f97316" // Warna teks (iOS)
          />
        }
      >
